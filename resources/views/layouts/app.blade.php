...
<head>
  ...
  <title>High School Information System</title>
...
@error('id_card')
  <script>
    toastr.error("Sorry, this user is not a Teacher!");
  </script>
@enderror
@error('guru')
  <script>
    toastr.error("Sorry, this Teacher is not a user!");
  </script>
@enderror
@error('no_induk')
  <script>
    toastr.error("Sorry, this user is not a Student");
  </script>
@enderror
@error('siswa')
  <script>
    toastr.error("Sorry, this Student is not a user");
  </script>
@enderror
@if (session('status'))
  <script>
